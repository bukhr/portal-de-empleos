...
class ActionCable::SubscriptionAdapter::SolidCable < ::ActionCable::SubscriptionAdapter::Base
  # source://solid_cable/3.0.8/lib/action_cable/subscription_adapter/solid_cable.rb#13
  def initialize(*_arg0); end

  # source://actioncable//lib/action_cable/subscription_adapter/channel_prefix.rb#8
  def broadcast(channel, payload); end

  # source://solid_cable/3.0.8/lib/action_cable/subscription_adapter/solid_cable.rb#32
  ...
  # source://solid_cable/3.0.8/lib/action_cable/subscription_adapter/solid_cable.rb#35
  def listener; end
end
